var Home = {template: "<section id='mainContent'><img src='images/profilePicturePlaceholder.png'><input type='checkbox' name='goingOut' value='out' id='goingOut'>Going out?<br>Location:<input type='text' name='location' id='location'><br><input type='submit' value='Submit' onclick='test()'></section>"
};
